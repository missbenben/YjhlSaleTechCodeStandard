                ...
                for (var k = 0; k < item.value.length; k++) {
                    ...
                    if (val != null) {
                        ...
                        if (percentAnimComplete >= 1) {
                            var data = { text: item.text, label: axisData.lLabels[k], value: val, indexX: k, indexY: i, fontsize: item.fontsize, fontcolor: item.fontcolor, fontweight: item.fontweight, click: item.click, mouseover: item.mouseover, mouseleave: item.mouseleave };
