...
(function () {
    ...
    var delayLoad = '', drawTypes = LChart.Const.NotDrawAxis.concat(LChart.Const.DrawAxis);
    for (var i = 0, type; type = drawTypes[i]; i++) {
        ...
        delayLoad += 'LChart.' + type + '._getCheckOptions = function() { loadScript(\'loongchart.' + type.toLowerCase() + '.\'); return LChart.' + type + '._getCheckOptions(); };';
    }
    eval(delayLoad);
})();