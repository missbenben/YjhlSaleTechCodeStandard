            ...
            if (axisData.multiple) {
                ...
                for (var k = 0; k < item.value.length; k++) {
                    ...
                    if (val != null) {
                        ...
                        var data = null;
                        if (complete) {
                            data = { text: item.text, label: axisData.lLabels[k], value: val, indexX: i, indexY: k, fontsize: item.fontsize, fontcolor: item.fontcolor, fontweight: item.fontweight, click: item.click, mouseover: item.mouseover, mouseleave: item.mouseleave };
