...
(function($, global){
    ...
    CanvasModel.prototype = {
        ...
        /**
         * 设置快照名称
         * @method setPictureName
         * @param {String} name 名称
         */
        setPictureName:function(name){
        ...
        save:function(name){
            var
                ...
                pname = this.getPictureName(),
                value = '';
            key=key+"-"+docname+"-"+pname;
            if(name!=undefined){
                key=name;
            }
            storage.init();    
